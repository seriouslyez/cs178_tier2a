...
export type RecursiveRequired<T extends Record<string, any>> = {
    [P in keyof T]-?: T[P] extends Record<string, any> | Array<any> ? RecursiveRequired<T[P]> : T[P];
};
export type ObjectSetter<Data extends Obj, Path extends string = string> = (<P extends Path, V extends Traverse<Data, P> = Traverse<Data, P>>(path: P, value: V) => void) & (<P extends Path, V extends Traverse<Data, P> = Traverse<Data, P>>(path: P, updater: (value: V) => V) => void) & ((value: Data) => void) & ((updater: (value: Data) => Data) => void);
export type UnknownObjectSetter<Data extends Obj, Path extends string = string> = ((path: string, value: unknown) => void) & (<P extends Path, V extends Traverse<Data, P> = Traverse<Data, P>>(path: P, updater: (value: V) => unknown) => void) & ((updater: (value: Data) => unknown) => void) & ((value: unknown) => void);
export type PartialErrorsSetter<Data extends Obj, Path extends string = string> = (<P extends Path, V extends Traverse<AssignableErrors<Data>, P> = Traverse<AssignableErrors<Data>, P>>(path: P, value: V) => void) & (<P extends Path, V extends Traverse<AssignableErrors<Data>, P> = Traverse<AssignableErrors<Data>, P>>(path: P, updater: (value: V) => V) => void) & ((value: AssignableErrors<Data>) => void) & ((updater: (value: Errors<Data>) => AssignableErrors<Data>) => void);
export type PrimitiveSetter<Data> = ((value: Data) => void) & ((updater: (value: Data) => Data) => void);
export type FieldsSetter<Data extends Obj, Path extends string = string> = (<P extends Path, V extends Traverse<Data, P> = Traverse<Data, P>>(path: P, value: V, shouldTouch?: boolean) => void) & (<P extends Path, V extends Traverse<Data, P> = Traverse<Data, P>>(path: P, updater: (value: V) => V, shouldTouch?: boolean) => void) & ((value: Data) => void) & ((updater: (value: Data) => Data) => void);
export type UnknownFieldsSetter<Data extends Obj, Path extends string = string> = (<P extends Path>(path: P, value: unknown, shouldTouch?: boolean) => void) & (<P extends Path, V extends Traverse<Data, P> = Traverse<Data, P>>(path: P, updater: (value: V) => unknown, shouldTouch?: boolean) => void) & ((value: unknown) => void) & ((updater: (value: Data) => unknown) => void);
export type Setter<Data, Path extends string = string> = Data extends Record<string, any> ? ObjectSetter<Data, Path> : PrimitiveSetter<Data>;
export type DeepSetResult<Data extends Obj | Obj[], Value> = {
    [key in keyof Data]: Data[key] extends Obj | Obj[] ? DeepSetResult<Data[key], Value> : Value;
};
...
export type KnownHelpers<Data extends Obj, Path extends string = string> = Omit<Helpers<Data, Path>, 'setData' | 'setFields'> & {
    setData: ObjectSetter<Data, Path>;
    setFields: FieldsSetter<Data, Path>;
};
export type UnknownHelpers<Data extends Obj, Path extends string = string> = Omit<Helpers<Data, Path>, 'setData' | 'setFields'> & {
...
export type Helpers<Data extends Obj, Path extends string = string> = {
    ...
    addField: <P extends Path, V extends Traverse<Data, Path> = Traverse<Data, Path>>(path: P, value: V, index?: number) => void;
...
export type AddValidatorFn<Data extends Obj> = (validator: ValidationFunction<Data>, options?: ValidatorOptions) => void;
...
export type CurrentForm<Data extends Obj> = MountedCurrentForm<Data> | SetupCurrentForm<Data>;
...
export type Extender<Data extends Obj = Obj> = (currentForm: MountedCurrentForm<Data> | SetupCurrentForm<Data>) => ExtenderHandler<Data>;
/** `Record<string, unknown>` */
export type Obj = Record<string, unknown>;
/** Possible field values. */
export type FieldValue = string | string[] | boolean | number | File | File[] | null | undefined;
export type FormControl = HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement;
export type ValidationFunction<Data extends Obj> = (values: Data) => AssignableErrors<Data> | undefined | Promise<AssignableErrors<Data> | undefined>;
export type TransformFunction<Data extends Obj> = (values: unknown) => Data;
export type SubmitContext<Data extends Obj> = {
    form?: HTMLFormElement;
    controls?: FormControl[];
    config: FormConfig<Data>;
} & Omit<Helpers<Data>, 'validate' | 'setIsSubmitting' | 'setIsDirty' | 'setInteracted'>;
...
export type FormConfigWithoutTransformFn<Data extends Obj> = {
    ...
    onSubmit?: (values: Data, context: SubmitContext<Data>) => Promise<unknown> | unknown;
    ...
    onSuccess?: (response: unknown, context: SubmitContext<Data>) => void | Promise<void>;
 ...
 */
export type FormConfig<Data extends Obj> = FormConfigWithTransformFn<Data> | FormConfigWithoutTransformFn<Data>;
type AnyObj = Record<string, any>;
type AnyArr = Array<any>;
/** The errors object may contain either a string or array or string per key. */
export type Errors<Data extends AnyObj | AnyArr> = Data extends AnyArr ? Data[number] extends AnyObj ? Errors<Data[number]>[] : string[] | null : Data extends Date | File | File[] ? string[] | null : Data extends AnyObj ? {
    [key in keyof Data]: Data[key] extends AnyObj | AnyArr ? Errors<Data[key]> : string[] | null;
} : any;
export type Keyed<Data extends AnyObj | AnyArr> = Data extends AnyArr ? Data[number] extends AnyObj ? (Keyed<Data[number]> & {
    key: string;
})[] : Data[number][] : Data extends Date | File | File[] ? Data : Data extends AnyObj ? {
    [key in keyof Data]: Data[key] extends AnyObj | AnyArr ? Keyed<Data[key]> : Data[key];
} : any;
/** The errors object may contain either a string or array or string per key. */
export type AssignableErrors<Data extends AnyObj | AnyArr> = Data extends AnyArr ? Data[number] extends AnyObj ? AssignableErrors<Data[number]>[] : string | string[] | null | undefined : Data extends Date | File | File[] ? string | string[] | null | undefined : Data extends AnyObj ? {
    [key in keyof Data]?: Data[key] extends AnyObj | AnyArr ? AssignableErrors<Data[key]> | undefined : string | string[] | null | undefined;
} : any;
/** The touched object may only contain booleans per key. */
export type Touched<Data extends AnyObj | AnyArr> = Data extends AnyArr ? Data[number] extends AnyObj ? Touched<Data[number]>[] : boolean : Data extends Date | File | File[] ? boolean : Data extends AnyObj ? {
    [key in keyof Data]: Data[key] extends AnyObj | AnyArr ? Touched<Data[key]> : boolean;
} : any;
...
export type UnknownStores<Data extends Obj, StoreExt = Record<string, any>> = Omit<Stores<Data, StoreExt>, 'data'> & {
    data: TransWritable<Data> & StoreExt;
};
export type KnownStores<Data extends Obj, StoreExt = Record<string, any>> = Omit<Stores<Data, StoreExt>, 'data'> & {
...
export type KeyedWritable<Data extends Obj> = Omit<Writable<Data>, 'subscribe'> & {
    subscribe(subscriber: (values: Keyed<Data>) => any): () => void;
};
...
export type StoreFactory<Ext = Record<string, any>> = <Value>(initialValue: Value) => Writable<Value> & Ext;
type Prev = [
    never,
    0,
    1,
...
type Split<Path extends string> = Path extends `${infer T}.${infer R}` ? [T, ...Split<R>] : [Path];
type TraverseImpl<T, Path extends unknown[]> = Path extends [
    infer K,
    ...infer R
] ? K extends keyof T ? TraverseImpl<T[K], R> : K extends `${number}` ? T extends Array<any> ? TraverseImpl<T[number], R> | undefined : any : any : T;
export type Traverse<T extends Record<string, any> | Array<any>, Path extends string> = TraverseImpl<T, Split<Path>>;
export {};
