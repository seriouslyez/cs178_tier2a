...
var app = (function () {
    ...
    ***************************************************************************** */
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label1, file, 17, 1, 454);
    			attr_dev(input1, "id", "lastName");
    			attr_dev(input1, "name", "lastName");
    			add_location(input1, file, 18, 1, 493);
    			add_location(br, file, 18, 34, 526);
    			attr_dev(button, "type", "submit");
    			add_location(button, file, 19, 1, 532);
    ...
    // (121:5) {#each days as day, i}
    function create_each_block_3(ctx) {
    	let th;
    	let t_value = /*day*/ ctx[32] + "";
    	let t;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(th, file$2, 121, 5, 3611);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*days*/ 4 && t_value !== (t_value = /*day*/ ctx[32] + "")) set_data_dev(t, t_value);
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(121:5) {#each days as day, i}",
    		ctx
    	});
    ...
    function create_each_block_2(ctx) {
    	...
    	function click_handler_1() {
    		return /*click_handler_1*/ ctx[18](/*i*/ ctx[29], /*j*/ ctx[34]);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", "notavailable sm");
    			add_location(button, file$2, 129, 7, 3940);
    			attr_dev(td, "nowrap", "");
    			set_style(td, "background", /*currAvail*/ ctx[0][/*i*/ ctx[29]][/*j*/ ctx[34]]);
    			set_style(td, "color", "black");
    			attr_dev(td, "id", td_id_value = /*dt*/ ctx[4][/*i*/ ctx[29]][/*j*/ ctx[34]]);
    			add_location(td, file$2, 128, 5, 3858);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if (dirty[0] & /*times*/ 8 && t_value !== (t_value = /*time*/ ctx[30] + "")) set_data_dev(t, t_value);

    			if (dirty[0] & /*currAvail*/ 1) {
    				set_style(td, "background", /*currAvail*/ ctx[0][/*i*/ ctx[29]][/*j*/ ctx[34]]);
    			}

    			if (dirty[0] & /*dt*/ 16 && td_id_value !== (td_id_value = /*dt*/ ctx[4][/*i*/ ctx[29]][/*j*/ ctx[34]])) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(128:3) {#each days as day, j}",
    		ctx
    	});
    ...
    function create_each_block_1(ctx) {
    	...
    	function click_handler() {
    		return /*click_handler*/ ctx[17](/*i*/ ctx[29]);
    	}

    	let each_value_2 = /*days*/ ctx[2];
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input, "id", input_id_value = /*ut*/ ctx[5][/*i*/ ctx[29]]);
    			attr_dev(input, "name", input_name_value = /*time*/ ctx[30]);
    			input.value = input_value_value = /*time*/ ctx[30];
    			add_location(input, file$2, 126, 13, 3728);
    			add_location(td, file$2, 126, 9, 3724);
    			attr_dev(tr, "id", tr_id_value = /*i*/ ctx[29]);
    			add_location(tr, file$2, 125, 3, 3703);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty[0] & /*ut*/ 32 && input_id_value !== (input_id_value = /*ut*/ ctx[5][/*i*/ ctx[29]])) {
    				attr_dev(input, "id", input_id_value);
    			}

    			if (dirty[0] & /*times*/ 8 && input_name_value !== (input_name_value = /*time*/ ctx[30])) {
    				attr_dev(input, "name", input_name_value);
    			}

    			if (dirty[0] & /*times*/ 8 && input_value_value !== (input_value_value = /*time*/ ctx[30])) {
    				prop_dev(input, "value", input_value_value);
    			}

    			if (dirty[0] & /*currAvail, dt, changeThisColor, times, days*/ 4125) {
    				each_value_2 = /*days*/ ctx[2];
    				validate_each_argument(each_value_2);
    				let i;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(125:3) {#each times as time, i}",
    		ctx
    	});
    ...
    // (139:1) {#each locationNames as location, i}
    function create_each_block(ctx) {
    	let button;
    	let t0_value = /*locationNames*/ ctx[6][/*i*/ ctx[29]] + "";
    	let t0;
    	let t1;
    	let button_id_value;
    	let br0;
    	...
    	function click_handler_2() {
    		return /*click_handler_2*/ ctx[19](/*location*/ ctx[27], /*i*/ ctx[29]);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			br0 = element("br");
    			br1 = element("br");
    			attr_dev(button, "id", button_id_value = /*location*/ ctx[27]);
    			set_style(button, "background", /*locs*/ ctx[8][/*i*/ ctx[29]]);
    			set_style(button, "color", "black");
    			set_style(button, "border", "solid red 2px");
    			attr_dev(button, "type", "button");
    			attr_dev(button, "class", "notavailable sm");
    			add_location(button, file$2, 139, 1, 4280);
    			add_location(br0, file$2, 140, 16, 4484);
    			add_location(br1, file$2, 140, 20, 4488);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if (dirty[0] & /*locationNames*/ 64 && t0_value !== (t0_value = /*locationNames*/ ctx[6][/*i*/ ctx[29]] + "")) set_data_dev(t0, t0_value);

    			if (dirty[0] & /*locationNames*/ 64 && button_id_value !== (button_id_value = /*location*/ ctx[27])) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(139:1) {#each locationNames as location, i}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	let each_value = /*locationNames*/ ctx[6];
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = text(/*currUser*/ ctx[7]);
    			t2 = space();
    			h2 = element("h2");
    			h2.textContent = "Note: all times in Eastern Standard Time.";
    			t4 = space();
    			form_1 = element("form");
    			table = element("table");
    			tr = element("tr");
    			th = element("th");
    			th.textContent = "All Days";
    			t6 = space();
    			...
    			t9 = space();
    			label = element("label");
    			label.textContent = "Preferred Location(s)";
    			br1 = element("br");
    			t11 = space();
    			...
    			add_location(h1, file$2, 112, 0, 3410);
    			add_location(h2, file$2, 113, 0, 3453);
    			add_location(div, file$2, 111, 0, 3404);
    			attr_dev(th, "nowrap", "");
    			add_location(th, file$2, 119, 5, 3553);
    			add_location(tr, file$2, 118, 3, 3543);
    			add_location(table, file$2, 117, 4, 3532);
    			add_location(br0, file$2, 136, 1, 4141);
    			attr_dev(label, "for", "aboutMe");
    			set_style(label, "font-weight", "bold");
    			set_style(label, "font-size", "1.5em");
    			add_location(label, file$2, 137, 1, 4147);
    			add_location(br1, file$2, 137, 90, 4236);
    			attr_dev(button0, "type", "button");
    			add_location(button0, file$2, 142, 1, 4503);
    			attr_dev(button1, "type", "submit");
    			add_location(button1, file$2, 143, 1, 4578);
    			add_location(form_1, file$2, 116, 0, 3512);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(button0, "click", /*click_handler_3*/ ctx[20], false, false, false),
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*currUser*/ 128) set_data_dev(t1, /*currUser*/ ctx[7]);

    			if (dirty[0] & /*days*/ 4) {
    				each_value_3 = /*days*/ ctx[2];
    				validate_each_argument(each_value_3);
    				let i;
    			...
    			if (dirty[0] & /*days, currAvail, dt, changeThisColor, times, ut, clickCheckbox*/ 20541) {
    				each_value_1 = /*times*/ ctx[3];
    				validate_each_argument(each_value_1);
    				let i;
    			...
    			if (dirty[0] & /*locationNames, locs, changeLocColor*/ 8512) {
    				each_value = /*locationNames*/ ctx[6];
    				validate_each_argument(each_value);
    				let i;
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	component_subscribe($$self, checks, $$value => $$invalidate(23, $checks = $$value));
    	validate_store(locations, 'locations');
    	component_subscribe($$self, locations, $$value => $$invalidate(24, $locations = $$value));
    	validate_store(availabilities, 'availabilities');
    	component_subscribe($$self, availabilities, $$value => $$invalidate(25, $availabilities = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
    	...
    	users.subscribe(val => {
    		$$invalidate(7, currUser = val[$currentUserNum]);
    	});

    	locations.subscribe(val => {
    		$$invalidate(8, locs = val[$currentUserNum]);
    	});
    	...
    	function changeLocColor(id, i) {
    		let currColor = document.getElementById(id).style.background;
    		document.getElementById(id).style.background = changeColor(currColor);
    		$$invalidate(8, locs[i] = document.getElementById(id).style.background, locs);
    	...
    	const click_handler = i => clickCheckbox(i);
    	const click_handler_1 = (i, j) => changeThisColor(dt[i][j], i, j, "auto");
    	const click_handler_2 = (location, i) => changeLocColor(location, i);
    	const click_handler_3 = () => onBack($data);

    	$$self.$$set = $$props => {
    		if ('initialValues' in $$props) $$invalidate(15, initialValues = $$props.initialValues);
    		...
    		if ('times' in $$props) $$invalidate(3, times = $$props.times);
    		...
    		if ('locationNames' in $$props) $$invalidate(6, locationNames = $$props.locationNames);
    	};
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('onSubmit' in $$props) $$invalidate(16, onSubmit = $$props.onSubmit);
    		if ('onBack' in $$props) $$invalidate(1, onBack = $$props.onBack);
    		if ('currUser' in $$props) $$invalidate(7, currUser = $$props.currUser);
    		if ('boxes' in $$props) boxes = $$props.boxes;
    		if ('locs' in $$props) $$invalidate(8, locs = $$props.locs);
    		if ('days' in $$props) $$invalidate(2, days = $$props.days);
    		if ('times' in $$props) $$invalidate(3, times = $$props.times);
    		if ('dt' in $$props) $$invalidate(4, dt = $$props.dt);
    		if ('currAvail' in $$props) $$invalidate(0, currAvail = $$props.currAvail);
