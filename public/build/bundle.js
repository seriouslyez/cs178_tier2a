...
var app = (function () {
    ...
    ***************************************************************************** */
    ...
    // (120:5) {#each days as day, i}
    function create_each_block_2(ctx) {
    	let th;
    	let t_value = /*day*/ ctx[25] + "";
    	let t;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(th, file$2, 120, 5, 3858);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*days*/ 4 && t_value !== (t_value = /*day*/ ctx[25] + "")) set_data_dev(t, t_value);
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(120:5) {#each days as day, i}",
    		ctx
    	});
    ...
    // (127:3) {#each days as day, j}
    function create_each_block_1(ctx) {
    	let td;
    	let button;
    	let t_value = /*time*/ ctx[22] + "";
    	let t;
    	let td_id_value;
    	let mounted;
    	let dispose;
    	...
    	function click_handler_1() {
    		return /*click_handler_1*/ ctx[15](/*i*/ ctx[24], /*j*/ ctx[27]);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$2, 128, 7, 4187);
    			attr_dev(td, "nowrap", "");
    			set_style(td, "background", /*currAvail*/ ctx[0][/*i*/ ctx[24]][/*j*/ ctx[27]]);
    			set_style(td, "color", "black");
    			attr_dev(td, "id", td_id_value = /*dt*/ ctx[4][/*i*/ ctx[24]][/*j*/ ctx[27]]);
    			add_location(td, file$2, 127, 5, 4105);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if (dirty & /*times*/ 8 && t_value !== (t_value = /*time*/ ctx[22] + "")) set_data_dev(t, t_value);

    			if (dirty & /*currAvail*/ 1) {
    				set_style(td, "background", /*currAvail*/ ctx[0][/*i*/ ctx[24]][/*j*/ ctx[27]]);
    			}

    			if (dirty & /*dt*/ 16 && td_id_value !== (td_id_value = /*dt*/ ctx[4][/*i*/ ctx[24]][/*j*/ ctx[27]])) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(127:3) {#each days as day, j}",
    		ctx
    	});
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input, "id", input_id_value = /*ut*/ ctx[5][/*i*/ ctx[24]]);
    			attr_dev(input, "name", input_name_value = /*time*/ ctx[22]);
    			input.value = input_value_value = /*time*/ ctx[22];
    			add_location(input, file$2, 125, 13, 3975);
    			add_location(td, file$2, 125, 9, 3971);
    			attr_dev(tr, "id", tr_id_value = /*i*/ ctx[24]);
    			add_location(tr, file$2, 124, 3, 3950);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*ut*/ 32 && input_id_value !== (input_id_value = /*ut*/ ctx[5][/*i*/ ctx[24]])) {
    				attr_dev(input, "id", input_id_value);
    			}

    			if (dirty & /*times*/ 8 && input_name_value !== (input_name_value = /*time*/ ctx[22])) {
    				attr_dev(input, "name", input_name_value);
    			}

    			if (dirty & /*times*/ 8 && input_value_value !== (input_value_value = /*time*/ ctx[22])) {
    				prop_dev(input, "value", input_value_value);
    			}

    			if (dirty & /*currAvail, dt, changeThisColor, times, days*/ 1053) {
    				each_value_1 = /*days*/ ctx[2];
    				validate_each_argument(each_value_1);
    				let i;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(124:3) {#each times as time, i}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$2, 112, 0, 3708);
    			add_location(div, file$2, 111, 0, 3702);
    			attr_dev(th, "nowrap", "");
    			add_location(th, file$2, 118, 5, 3800);
    			add_location(tr, file$2, 117, 3, 3790);
    			add_location(table, file$2, 116, 4, 3779);
    			attr_dev(label, "for", "aboutMe");
    			add_location(label, file$2, 135, 1, 4369);
    			attr_dev(textarea, "id", "aboutMe");
    			attr_dev(textarea, "name", "aboutMe");
    			add_location(textarea, file$2, 136, 1, 4411);
    			add_location(br, file$2, 136, 37, 4447);
    			attr_dev(button0, "type", "button");
    			add_location(button0, file$2, 137, 1, 4453);
    			attr_dev(button1, "type", "submit");
    			add_location(button1, file$2, 138, 1, 4528);
    			add_location(form_1, file$2, 115, 0, 3759);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*currUser*/ 64) set_data_dev(t1, /*currUser*/ ctx[6]);
    			...
    			if (dirty & /*days, currAvail, dt, changeThisColor, times, ut, clickCheckbox*/ 3133) {
    				each_value = /*times*/ ctx[3];
    				validate_each_argument(each_value);
    				let i;
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	component_subscribe($$self, currentUserNum, $$value => $$invalidate(18, $currentUserNum = $$value));
    	validate_store(checks, 'checks');
    	component_subscribe($$self, checks, $$value => $$invalidate(19, $checks = $$value));
    	validate_store(availabilities, 'availabilities');
    	component_subscribe($$self, availabilities, $$value => $$invalidate(20, $availabilities = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
    	...
    	users.subscribe(val => {
    		$$invalidate(6, currUser = val[$currentUserNum]);
    	});
    	...
    	const click_handler_2 = () => onBack($data);
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('onSubmit' in $$props) $$invalidate(13, onSubmit = $$props.onSubmit);
    		if ('onBack' in $$props) $$invalidate(1, onBack = $$props.onBack);
    		if ('currUser' in $$props) $$invalidate(6, currUser = $$props.currUser);
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	validate_store(currentUserNum, 'currentUserNum');
    	component_subscribe($$self, currentUserNum, $$value => $$invalidate(10, $currentUserNum = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
